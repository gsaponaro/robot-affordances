...
function [score] = train_hand_test_hand
%%
...
% data_test=training_data; % test overfitting
...
training_data_7nodes = [score training_data(:,25) effects];
BN = dgmTrainFullyObs(BN, training_data_7nodes);
save('../data+combinator/pca_2n2c2v_hh.mat','BN','ranges','pcH','pcO','components','mu_train','sigma_train');
...
% test_data = training_data_7nodes;
