...
function posterior = train_tool_select_manipulator(query, whichbn)
...
if nargin < 2
    whichbn = 'pca_2n2c2v_tt';
end

% confirm that whichbn is one of the permitted ones
assert(strcmp(whichbn,'pca_2n2c2v_tt'), 'you must specify a permitted network')
